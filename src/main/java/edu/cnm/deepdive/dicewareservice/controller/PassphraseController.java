...
public class PassphraseController {
  ...
  public Passphrase get(@PathVariable String key, Authentication auth) {
    return passphraseRepository.getPassphraseByUserAndKey((User) auth.getPrincipal(), key).get();
  }
  ...
  public Passphrase put(@PathVariable long id, @RequestBody Passphrase passphrase,
      @RequestParam(defaultValue = "false") boolean regenerate,  @RequestParam(defaultValue = "6") int length,
      Authentication auth) {
